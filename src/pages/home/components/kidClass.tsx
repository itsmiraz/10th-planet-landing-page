...
const KidClass = () => {
  return (
    <div className="flex mt-[200px] mb-[170px] font-jakarta gap-[160px] justify-between  bg-gradient-to-r from-[#12100E] to-[#171717]">
      <div className="py-[69px] px-[67px]">
        <h2 className="text-[32px] pb-[25px] font-bold ">Join The Kid Class</h2>
        <p className="text-[22px] max-w-[620px]">
        ...
        <div className="flex mt-[20px] items-center gap-x-6">
